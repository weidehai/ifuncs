...
test("sort", () => {
  expect(ifuncs.sort.selectSort([3, 2, 1])).toEqual([1, 2, 3]);
  expect(ifuncs.sort.quickSort([3, 2, 1])).toEqual([1,2,3]);
  expect(ifuncs.sort.insertOrder([3, 2, 1])).toEqual([1,2,3]);
  expect(ifuncs.sort.hillSort([3, 2, 1],4)).toEqual([1,2,3]);
  expect(ifuncs.sort.hillSort([23, 10, 34, 31, 6, 59, 30, 20, 9, 63, 40, 39, 43, 6],4)).toEqual([6,6,9,10,20,23,30,31,34,39,40,43,59,63]);
  expect(ifuncs.sort.multipleOrder([3, 2, 1])).toEqual([1,2,3]);
  expect(ifuncs.sort.multipleOrder([23, 10, 34, 31, 6, 59, 30, 20, 9, 63, 40, 39, 43, 6])).toEqual([6,6,9,10,20,23,30,31,34,39,40,43,59,63]);
